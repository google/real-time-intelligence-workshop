...
def run(project, bucket, region, input):
    if input == 'local':
        ...
        flights_output = 'gs://{}/train/data/'.format(bucket)
    ...
    with beam.Pipeline(argv=argv) as pipeline:
        ...
        if input == 'local':
            ...
            input_table = 'flights.flights_tzcorr'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-b', '--bucket', help='Training data will be written to gs://BUCKET/train/')
